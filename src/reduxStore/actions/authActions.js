...
export const signUp = newUser => {
  ...
  return (dispatch, getState) => {
  dispatch({ type: "SIGNUP_ERROR", payload: "Cant create new users, db is disconnected, we are too far from alpha centauri" });
...
export const editUser = userData => {
  ...
  return (dispatch, getState) => {
  dispatch({ type: "USEREDIT_ERROR", payload: "Cant edit users anymore, this is just a hoax" });
...
export const grantMOD = email => {
  ...
  return (dispatch, getState) => {  
    dispatch({ type: "USER_GRANT_ADMIN_ERROR", payload: "Cant grant mods anymore" });
